...
public class DWRFileUtil {
  ...
  /**
   * Generates a PDF file with the given text http://itext.ugent.be/itext-in-action/
   * 
   ...
   * @return The altered image
   */
  private BufferedImage grafitiTextOnImage(BufferedImage uploadImage, String uploadFile,
      String color) {
