...
/**
 * A data populator that creates a set of security tables and test data
 * that can be used by the Shiro Spring sample application to demonstrate
 * the use of the {@link org.apache.shiro.realm.jdbc.JdbcRealm} The tables
 * created by this class follow the default table and column names that
