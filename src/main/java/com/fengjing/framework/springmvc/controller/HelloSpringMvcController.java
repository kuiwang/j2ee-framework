...
/**
 * ��ʹ��org.springframework.web.servlet.handler.SimpleUrlHandlerMapping����
 * ����·������Ϊ /hello/jsp.do /hello/velocity.do /hello/freemarker.do
...
public class HelloSpringMvcController {
    ...
    /**
     * �ӵ�ַ�����ܲ��� /hello/showUser/admin/admin.do nameΪadmin pwdΪadmin
     * ����ת����showuser.jsp
     * 
     * @param username
     * @param password
