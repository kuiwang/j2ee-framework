...
public class ContactController {
    ...
    public @ResponseBody List<Contact> alltoJson(
            @ModelAttribute(value = "contact") Contact contact, BindingResult result) {
    ...
    public ModelAndView listAll(@PathVariable(value = "pageNumber") int pageNumber,
    ...
    public ModelAndView findByAgeLessThanOrderByIdDesc(
        ...
        Page<Contact> pagingdata = contactService.findByAgeLessThanEqualOrderByIdDesc(age,
                pageRequest);
        ModelAndView modelAndView = new ModelAndView();
        modelAndView.setViewName("list");//��ת��list.jsp
        modelAndView.addObject("alllist", pagingdata.getContent());
