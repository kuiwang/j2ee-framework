...
/**
 * �ÿ�������spring�����б�ʶΪsimpleUrlController ������org.springframework.web
 * .servlet.handler.SimpleUrlHandlerMapping�����б��� ���spring-mvc-servlet.xml�� <bean
 * id="simpleUrlHandlerMapping" class=
 * "org.springframework.web.servlet.handler.SimpleUrlHandlerMapping"> ��<prop
 * key="/simpleurl.do">simpleUrlController</prop>������ ���������������·��Ϊ /simpleurl/jsp.do
 * /simpleurl/velocity.do /simpleurl/freemarker.do
 * 
 * @author fengjing
 *
 */
...
public class SimpleUrlController {
  ...
  /**
   * �ӵ�ַ�����ܲ��� /simpleurl/showuser/admin/admin.do nameΪadmin pwdΪadmin ����ת����showuser.jsp
   * 
   * @param username
   * @param password
   * @param map
