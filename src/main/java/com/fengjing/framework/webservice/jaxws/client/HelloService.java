...
@WebServiceClient(name = "HelloService",
    ...
    wsdlLocation = "http://localhost:8080/maven-framework/service/hello?wsdl")
public class HelloService extends Service {

  private final static URL HELLOSERVICE_WSDL_LOCATION;
  private final static Logger logger = Logger
      .getLogger(com.fengjing.framework.webservice.jaxws.client.HelloService.class.getName());
  ...
  static {
    ...
    try {
      ...
      logger
          .warning("Failed to create URL for the wsdl Location: 'http://localhost:8080/maven-framework/service/hello?wsdl', retrying as a local file");
  ...
  public HelloService() {
    super(HELLOSERVICE_WSDL_LOCATION, new QName(
        "http://service.jaxws.webservice.framework.fengjing.com/", "HelloService"));
  }
  ...
  public Hello getHelloPort() {
    return super.getPort(new QName("http://service.jaxws.webservice.framework.fengjing.com/",
