...
public class ObjectFactory {
  ...
  private final static QName _SayHello_QNAME = new QName(
      "http://service.jaxws.webservice.framework.fengjing.com/", "sayHello");
  private final static QName _SayHelloResponse_QNAME = new QName(
      "http://service.jaxws.webservice.framework.fengjing.com/", "sayHelloResponse");
  private final static QName _Print_QNAME = new QName(
      "http://service.jaxws.webservice.framework.fengjing.com/", "print");
  private final static QName _GetAllUsers_QNAME = new QName(
      "http://service.jaxws.webservice.framework.fengjing.com/", "getAllUsers");
  private final static QName _SayHelloUsingSpring_QNAME = new QName(
      "http://service.jaxws.webservice.framework.fengjing.com/", "sayHelloUsingSpring");
  private final static QName _SayHelloUsingSpringResponse_QNAME = new QName(
      "http://service.jaxws.webservice.framework.fengjing.com/", "sayHelloUsingSpringResponse");
  private final static QName _GetAllUsersResponse_QNAME = new QName(
      "http://service.jaxws.webservice.framework.fengjing.com/", "getAllUsersResponse");
  private final static QName _PrintResponse_QNAME = new QName(
      "http://service.jaxws.webservice.framework.fengjing.com/", "printResponse");

  /**
   * Create a new ObjectFactory that can be used to create new instances of schema derived classes
   * for package: com.fengjing.framework.webservice.jaxws.client
   * 
   */
   ...
   * 
   */
  @XmlElementDecl(namespace = "http://service.jaxws.webservice.framework.fengjing.com/",
      name = "sayHello")
  ...
  public JAXBElement<SayHelloResponse> createSayHelloResponse(SayHelloResponse value) {
    return new JAXBElement<SayHelloResponse>(_SayHelloResponse_QNAME, SayHelloResponse.class, null,
        value);
  }
   ...
   */
  @XmlElementDecl(namespace = "http://service.jaxws.webservice.framework.fengjing.com/",
      name = "sayHelloUsingSpring")
  public JAXBElement<SayHelloUsingSpring> createSayHelloUsingSpring(SayHelloUsingSpring value) {
    return new JAXBElement<SayHelloUsingSpring>(_SayHelloUsingSpring_QNAME,
        SayHelloUsingSpring.class, null, value);
  }
   ...
   */
  @XmlElementDecl(namespace = "http://service.jaxws.webservice.framework.fengjing.com/",
      name = "sayHelloUsingSpringResponse")
  public JAXBElement<SayHelloUsingSpringResponse> createSayHelloUsingSpringResponse(
      SayHelloUsingSpringResponse value) {
    return new JAXBElement<SayHelloUsingSpringResponse>(_SayHelloUsingSpringResponse_QNAME,
        SayHelloUsingSpringResponse.class, null, value);
  }
