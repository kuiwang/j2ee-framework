...
public class StudentClientDetails {
  ...
  public void sendRequesetBySOAPMessage() throws Exception {
    ...
    /*
     * SOAP��Ϣ <?xml version="1.0" encoding="UTF-8"?> <SOAP-ENV:Envelope
     * xmlns:SOAP-ENV="http://schemas.xmlsoap.org/soap/envelope/"> <SOAP-ENV:Header />
     * <SOAP-ENV:Body> <tns:studentRequest xmlns:tns="http://www.example.org/student">
     * <Name>ʹ��SpringWS����������Լ���ȵ�WebService</Name> <Subject1>1</Subject1>
     * <Subject2>3</Subject2> <Subject3>5</Subject3> </tns:studentRequest> </SOAP-ENV:Body>
     * </SOAP-ENV:Envelope>
     */
    ...
    /*
     * 2������Service��һ������Ϊwsdl URL��ַ,�ڶ�������WebService service��name StudentDetailsService
     * �μ�wsdl�е�<wsdl:service name="StudentDetailsService">
     */
    Service service = Service.create(url, new QName(NAMESPACE_URI, "StudentDetailsService"));
    /*
     * 3������Dispatch ��һ������ΪportName �μ�wsdl�е�<wsdl:port binding="tns:StudentDetailsSoap11"
     * name="StudentDetailsSoap11"> �ڶ�������ΪSOAP��Ϣ���������͵� ��������ʹ��SOAPMessage
     * ������������ָ��Ϣ�������������͵� MESSAGE provides access to entire protocol message, PAYLOAD
     * to protocol message
     */
    Dispatch<SOAPMessage> dispatch =
        service.createDispatch(new QName(NAMESPACE_URI, "StudentDetailsSoap11"), SOAPMessage.class,
     ...
     * <SOAP-ENV:Header/> <SOAP-ENV:Body> <ns2:studentResponse
     * xmlns:ns2="http://www.example.org/student"
     * xmlns:SOAP-ENV="http://schemas.xmlsoap.org/soap/envelope/"
     * xmlns:xml="http://www.w3.org/XML/1998/namespace">
     * <ns2:Name>ʹ��SpringWS����������Լ���ȵ�WebService</ns2:Name>
     * <ns2:Department>MCA</ns2:Department> <ns2:Subject1>1</ns2:Subject1>
     * <ns2:Subject2>3</ns2:Subject2> <ns2:Subject3>5</ns2:Subject3> <ns2:Total>9</ns2:Total>
     * </ns2:studentResponse> </SOAP-ENV:Body> </SOAP-ENV:Envelope>
     */
    Document document =
        soapMessage.getSOAPPart().getEnvelope().getBody().extractContentAsDocument();

    String name = document.getElementsByTagNameNS(NAMESPACE_URI, "Name").item(0).getTextContent();
    String department =
        document.getElementsByTagNameNS(NAMESPACE_URI, "Department").item(0).getTextContent();
    String subject1 =
        document.getElementsByTagNameNS(NAMESPACE_URI, "Subject1").item(0).getTextContent();
    String subject2 =
        document.getElementsByTagNameNS(NAMESPACE_URI, "Subject2").item(0).getTextContent();
    String subject3 =
        document.getElementsByTagNameNS(NAMESPACE_URI, "Subject3").item(0).getTextContent();
  ...
  public void sendRequesetByPAYLOAD() throws Exception {
    // 1��ƴ��payload
    String payload =
        "<tns:studentRequest xmlns:tns=\"http://www.example.org/student\"><Name>ʹ��SpringWS����������Լ���ȵ�WebService</Name><Subject1>1</Subject1><Subject2>3</Subject2><Subject3>5</Subject3></tns:studentRequest>";

    // 2������wsdl URL��ַ
    url = new URL("http://localhost:8080/maven-framework/sws/services/studentDetails.wsdl");
    /*
     * 3������Service��һ������Ϊwsdl URL��ַ,�ڶ�������WebService service��name StudentDetailsService
     * �μ�wsdl�е�<wsdl:service name="StudentDetailsService">
     */
    Service service = Service.create(url, new QName(NAMESPACE_URI, "StudentDetailsService"));

    /*
     * 4������Dispatch ��һ������ΪportName �μ�wsdl�е�<wsdl:port binding="tns:StudentDetailsSoap11"
     * name="StudentDetailsSoap11"> �ڶ�������ΪSOAP��Ϣ���������͵� ��������ʹ��Source
     * ������������ָ��Ϣ�������������͵� MESSAGE provides access to entire protocol message, PAYLOAD
     * to protocol message
     */
    Dispatch<Source> dispatch =
        service.createDispatch(new QName(NAMESPACE_URI, "StudentDetailsSoap11"), Source.class,
