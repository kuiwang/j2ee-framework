...
public class StudentDetailsClient {
  ...
  private SOAPMessage createStudentRequest() throws SOAPException {
    ...
    name.addTextNode("ʹ��SpringWS����������Լ���ȵ�WebService");
  ...
  private void writeStudentResponse(SOAPMessage message) throws SOAPException {
    ...
    SOAPBody soapBody = message.getSOAPBody();
    SOAPElement studentResponse =
        (SOAPElement) soapBody.getChildElements(studentResponseName).next();
    ...
    /*
     * SOAPElement name = (SOAPElement) studentResponse.getChildElements(envelope.createName("Name",
     * PREFIX, NAMESPACE_URI)).next(); System.out.println(name.getLocalName()+":"+nme.getValue());
     * 
     * SOAPElement department = (SOAPElement)
     * studentResponse.getChildElements(envelope.createName("Department", PREFIX,
     * NAMESPACE_URI)).next();
     * System.out.println(department.getLocalName()+":"+department.getValue());
     * 
     * SOAPElement subject1 = (SOAPElement)
     * studentResponse.getChildElements(envelope.createName("Subject1", PREFIX,
     * NAMESPACE_URI)).next(); System.out.println(subject1.getLocalName()+":"+subject1.getValue());
     * 
     * SOAPElement subject2 = (SOAPElement)
     * studentResponse.getChildElements(envelope.createName("Subject2", PREFIX,
     * NAMESPACE_URI)).next(); System.out.println(subject2.getLocalName()+":"+subject2.getValue());
     * 
     * SOAPElement subject3 = (SOAPElement)
     * studentResponse.getChildElements(envelope.createName("Subject3", PREFIX,
     * NAMESPACE_URI)).next(); System.out.println(subject3.getLocalName()+":"+subject3.getValue());
     * 
     * SOAPElement total = (SOAPElement)
     * studentResponse.getChildElements(envelope.createName("Total", PREFIX, NAMESPACE_URI)).next();
